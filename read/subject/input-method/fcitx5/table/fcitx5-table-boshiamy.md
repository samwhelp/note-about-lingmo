...
> 如何安裝「[fcitx5-table-boshiamy](https://packages.debian.org/stable/fcitx5-table-boshiamy)」
...
| 微調腳本 | 中文輸入法 |
| -------- | ---------- |
| [fcitx5-table-boshiamy 安裝設定腳本](https://github.com/samwhelp/lingmo-adjustment/tree/main/prototype/main/im-config/fcitx5/fcitx5-table-boshiamy) | 嘸蝦米輸入法 |
...
執行下面指令，安裝「[fcitx5-table-boshiamy](https://packages.debian.org/stable/fcitx5-table-boshiamy)」和「[fcitx5-chinese-addons](https://packages.debian.org/stable/fcitx5-chinese-addons)」。
